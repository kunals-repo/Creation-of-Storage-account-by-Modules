**Azure Storage Account Deployment using Terraform Modules**

This project demonstrates how to create an Azure Storage Account, containers, and associated block blobs using Terraform modules. By leveraging modules, the infrastructure code is organized, reusable, and easier to manage.
